...
class Tux extends FlxSprite
{
    ...
    public function new()
    {
        ...
        // XML Spritesheet stuff
        if (currentState == Small) // Small Tux has no jump or duck animation.
        {
            frames = smallTuxImage;
            animation.addByPrefix('stand', 'stand', 8, false);
        ...
        if (currentState == Big)
        {
            ...
            animation.addByPrefix('duck', 'duck', 8, false);
            animation.play('stand');
        }
        if (currentState == Fire)
        {
            ...
            animation.addByPrefix('duck', 'duck', 12, false);
            animation.play('stand');
        }
    }
	...
	override public function update(elapsed:Float)
	{
        ...
        if (velocity.y > 1 && (currentState == Big || currentState == Fire))
        {
            animation.play('jump');
        }
