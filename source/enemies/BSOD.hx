...
class BSOD extends FlxSprite
{
    ...
    // Enemy Image
    var enemyImage = FlxAtlasFrames.fromSparrow("assets/images/characters/bsod.png", "assets/images/characters/bsod.xml");
    ...
    public function new(x:Float = 0, y:Float = 0)
    {
        ...
        animation.play('walk'); // note to self: NEVER. FORGET. THIS.
    }
